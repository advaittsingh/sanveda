...
export default function EnquiriesAdminPage() {
  ...
  const assignees = useMemo(() => {
    if (!dashboard) return []
    return [...new Set(dashboard.enquiries.map((e) => e.assignedTo).filter(Boolean))]
  }, [dashboard])
      ...
      {loading && !dashboard ? (
        ...
        <AdminCard>
          <div className="flex flex-col items-start gap-3 py-6" role="alert">
            <h3 className="text-lg font-semibold text-red-700">Could not load enquiries</h3>
            ...
            {filteredEnquiries.length === 0 ? (
              ...
              <DataTable
                columns={[
                  ...
                  { key: 'assigned', header: 'Assigned To', render: (e) => e.assignedTo || 'Unassigned' },
