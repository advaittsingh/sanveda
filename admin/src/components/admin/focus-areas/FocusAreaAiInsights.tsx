...
interface Props {
  insights: FocusAreaDashboardData['aiInsights']
}

export default function FocusAreaAiInsights({ insights }: Props) {
  return (
    <AdminCard>
      <div className="mb-4 flex items-start justify-between gap-3">
        <div>
          <h3 className="text-base font-semibold text-[#0B2C6B]">AI Insights</h3>
          <p className="text-sm text-slate-500">Strategic programme intelligence across focus areas</p>
        </div>
