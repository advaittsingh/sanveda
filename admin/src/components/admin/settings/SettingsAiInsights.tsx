...
interface Props {
  insights: SettingsDashboardData['aiInsights']
}

export default function SettingsAiInsights({ insights }: Props) {
  return (
    <AdminCard>
      <div className="mb-4 flex items-start justify-between gap-3">
        <div>
          <h3 className="text-base font-semibold text-[#0B2C6B]">Platform Intelligence</h3>
          <p className="text-sm text-slate-500">Configuration health and system status</p>
        </div>
