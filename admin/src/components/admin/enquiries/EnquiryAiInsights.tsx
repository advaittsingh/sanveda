...
interface Props {
  insights: EnquiryDashboardData['aiInsights']
}

export default function EnquiryAiInsights({ insights }: Props) {
  return (
    <AdminCard>
      <div className="mb-4 flex items-start justify-between gap-3">
        <div>
          <h3 className="text-base font-semibold text-[#0B2C6B]">AI Insights</h3>
          <p className="text-sm text-slate-500">Lead intelligence and support desk recommendations</p>
        </div>
