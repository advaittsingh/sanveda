import type { Department, RbacFilters, RoleDefinition } from '../../../lib/adminUserOperationsService'
...
export default function RbacFiltersPanel({ filters, departments, roles, onChange }: Props) {
  return (
