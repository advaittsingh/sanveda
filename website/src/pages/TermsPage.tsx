...
import { TERMS_PAGE, TERMS_SECTIONS } from '../constants/termsContent'
...
export default function TermsPage() {
  ...
  return (
    <div className="policy-doc-page">
      <AboutBreadcrumb
        items={[{ label: 'Home', path: '/' }, { label: TERMS_PAGE.breadcrumb, path: null }]}
      />

      <div className="page-banner-wrap" data-mobile={heroMobile}>
        <SubPageBanner title={TERMS_PAGE.title} subtitle={TERMS_PAGE.description} />
      </div>
        ...
        <div className="policy-doc-layout">
          {!mobile && (
            <aside className="policy-doc-sidebar">
              <PolicyTableOfContents sections={TERMS_SECTIONS} />
            </aside>
          )}
      ...
      {mobile && tocOpen && (
        <div className="policy-doc-drawer" role="dialog" aria-modal="true" aria-label="Table of contents">
          ...
          <div className="policy-doc-drawer-panel">
            ...
            <PolicyTableOfContents sections={TERMS_SECTIONS} onNavigate={closeToc} />
          </div>
        </div>
      )}
    </div>
