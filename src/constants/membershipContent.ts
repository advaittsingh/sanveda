...
export const MEMBERSHIP_STATS = [
  ...
  { value: '₹2Cr+', label: 'Donations Facilitated' },
] as const
...
export const MEMBERSHIP_TESTIMONIALS = [
  {
    id: 1,
    quote:
      'Being a Sanveda member allowed me to directly contribute to education initiatives across India. The annual impact report showed exactly where my support went.',
    name: 'Rahul Sharma',
    role: 'Patron Member',
  },
  {
    id: 2,
    quote:
      'The networking events and advisory roundtables gave me a meaningful way to stay engaged beyond donations. Sanveda truly values its members.',
    name: 'Priya Mehta',
  ...
  },
  {
    id: 3,
    quote:
      'As a Standard Member, I still feel deeply connected to the mission through newsletters, events, and volunteer opportunities.',
    name: 'Arjun Desai',
