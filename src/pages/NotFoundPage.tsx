...
export default function NotFoundPage() {
  return (
    <div style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, textAlign: 'center', background: C.grayBg }}>
      <div>
        <h1 style={{ fontWeight: 800, fontSize: 'clamp(48px, 15vw, 72px)', color: C.secondary, margin: '0 0 8px' }}>404</h1>
        <h2 style={{ fontWeight: 800, fontSize: 'clamp(20px, 5vw, 24px)', color: C.primary, margin: '0 0 12px' }}>Page Not Found</h2>
