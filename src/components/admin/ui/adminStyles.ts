...
export const adminInputClass =
  'w-full rounded-xl border border-[#E5E7EB] bg-white px-3 py-2.5 text-sm text-slate-700 outline-none transition focus:border-[#041B4D]/30 focus:ring-2 focus:ring-[#041B4D]/10'

export const adminBtnPrimary =
  'inline-flex items-center justify-center rounded-xl bg-[#041B4D] px-4 py-2 text-sm font-semibold text-white transition hover:opacity-90 disabled:opacity-50'
