          ...
          <section>
            ...
            <div className="flex flex-wrap gap-2">
              {(member.status === 'active' || member.status === 'approved') && member.memberId ? (
                <>
                  <button type="button" className={adminBtnSecondary} onClick={() => downloadMembershipCertificate(member)}>
                    <Download size={14} className="mr-1.5" />
                    Download Certificate
                  </button>
                  <button type="button" className={adminBtnSecondary} onClick={() => downloadMemberIdCard(member)}>
                    Download ID Card
                  </button>
