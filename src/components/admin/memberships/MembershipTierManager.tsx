...
import { saveTierConfigs, type MembershipTierConfig } from '../../../lib/membershipOperationsService'
            ...
            {editing ? (
              ...
              <>
                ...
                <p className="mt-1 text-lg font-bold text-[#0E4FA8]">
                  {tier.price === 0 ? 'Free' : `₹${tier.price.toLocaleString('en-IN')}${tier.validityMonths ? '/year' : ''}`}
                </p>
