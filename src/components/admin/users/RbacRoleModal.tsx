...
export default function RbacRoleModal({ open, onClose, onSave }: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-md rounded-2xl bg-white shadow-xl">
        <div className="flex items-center justify-between border-b border-[#E5E7EB] p-5">
          <h2 className="text-lg font-semibold text-[#0B2C6B]">Create Role</h2>
        ...
        >
          ...
          <div className="flex justify-end gap-2">
            ...
            <button type="submit" className={adminBtnPrimary}>Create Role</button>
          </div>
        </form>
      </div>
    </div>
