                  ...
                  {ACCESS_MODULES.map((mod) => (
                    <span
                      ...
                      className={`rounded-full px-3 py-1 text-xs font-semibold ${
                        modules.includes(mod) ? 'bg-emerald-50 text-emerald-700' : 'bg-slate-100 text-slate-400'
                      }`}
                    >
                      {mod}
                    </span>
              ...
              <div>
                ...
                <div className="overflow-x-auto rounded-xl border border-[#E5E7EB]">
                  <table className="w-full min-w-[480px] text-xs">
                    ...
                    <tbody>
                      {ACCESS_MODULES.map((mod) => {
                        const row = userPerms.find((p) => p.module === mod) ?? {
                          module: mod, view: false, create: false, edit: false, delete: false, approve: false, export: false,
                        }
                        return (
